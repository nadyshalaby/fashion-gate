...
<html>
  ...
  <head>
    ...
    <link type="text/css" rel="stylesheet" href="wedding accessories.css" />
  ...
  <body>
    <div class="container-fluid">
      ...
      <?php
      @ include '../rooting.php';
      $abs_path = URL."\\public\\pics\\wedding accessories\\";
      $rel_path = "../public/pics/wedding accessories/";
      $link = "../wedding accessories/";
      $dir = new DirectoryIterator($abs_path);
      echo"
      <div class='header container-fluid row'>
        <div class='logo-desc row'>
          <h1>Wedding Accessories</h1>
        </div>
      </div>
      <div id='top-sailed' class='top-sailed row container-fluid'>
        <div class='top-sailed-label'>
          <h1 class='label label-success'> Wedding Accessories Products List</h1>
        </div>
    ...
    <script src="wedding accessories.js"></script>
