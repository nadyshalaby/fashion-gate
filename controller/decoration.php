<?php
@ include '../rooting.php';
$abs_path = URL."\\public\\pics\\decoration\\";
$rel_path = "../public/pics/decoration/";
$link = "../decoration/";
...
<div id='top-sailed' class='top-sailed row container-fluid'>
    <div class='top-sailed-label'>
        <h1 class='label label-success'>Top Sailed Decoration<button link='$link' class='btn btn-default load-more'>load more</button></h1>
    </div>
